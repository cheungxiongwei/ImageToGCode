- [基于OpenCV灰度图像转GCode的双向扫描实现](#基于opencv灰度图像转gcode的双向扫描实现)
  - [引言](#引言)
  - [激光雕刻简介](#激光雕刻简介)
  - [OpenCV简介](#opencv简介)
  - [实现步骤](#实现步骤)
    ...
    - [3. 图像预处理](#3-图像预处理)
    - [4. 生成GCode](#4-生成gcode)
      - [1. 简化版的双向扫描](#1-简化版的双向扫描)
      - [2. 优化版的双向扫描](#2-优化版的双向扫描)
    - [5. 保存生成的GCode](#5-保存生成的gcode)
    - [6. 灰度图像双向扫描代码示例](#6-灰度图像双向扫描代码示例)
  - [总结](#总结)

# 基于OpenCV灰度图像转GCode的双向扫描实现

![双向扫描](./../asset/双向扫描截图.png)

![双向扫描](./../asset/双向扫描优化版截图.png)

![双向扫描](./../asset/双向扫描优化版动画.gif)
